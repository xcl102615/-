...
<table class="easyui-datagrid" title="用户信息管理" style="height:auto" id="dgUser"
    ...
    <tr>
        ...
        <th data-options="field:'lastLoginIpAddress',width:60">上次登录的IP</th>
        <th data-options="field:'ild',width:60,formatter:format">大小</th>
    </tr>
    </thead>
</table>
<script>
...
<script>
        ...
        function format(val,row){
            var rs="<a href='javascript:void(0)'class='btnUpdate' id='"+val+"'>编辑</a>";
            return rs;
        }
</script>
</body>
