...
public class OrderServiceImpl extends BaseService implements OrderService {
     ...
     * @return
     */
    public AjaxResult findMonthSaleNum(String shopId){
        return AjaxResult.build("1","查询成功",dao.findMonthSaleNum(shopId));
    }
     ...
     * @return
     */
    public AjaxResult updateOrderDetails(OrderDetails orderDetails){
        return AjaxResult.build(String.valueOf(dao.updateOrderDetails(orderDetails)),"系统已响应您的请求");
    }
